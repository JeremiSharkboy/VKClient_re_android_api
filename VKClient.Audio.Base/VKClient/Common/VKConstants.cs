...
namespace VKClient.Common
{
    ...
    {
        public static readonly string API_VERSION = "5.68";//todo: bug? 5.63
        ...
        public static readonly string ApplicationID = "2274003";//android
        //public static readonly string ApplicationID = "3502561";//wp
        public static readonly string ApplicationSecretKey = "hHbZxrka2uZ6jB1inYsH";//android
        //public static readonly string ApplicationSecretKey = "omvP3y2MZmpREFZJDNHd";//wp
        ...
        public static readonly List<string> SupportedVideoExtensions = new List<string>() { ".mp4", ".mov", ".wmv", ".3gp", ".3g2" };
        public static readonly List<string> SupportedAudioExtensions = new List<string>() { ".mp3" };
        public static readonly List<string> SupportedDocLibraryExtensions = new List<string>() { ".mp4", ".mov", ".wmv", ".3gp", ".3g2", ".jpg", ".png", ".gif" };
