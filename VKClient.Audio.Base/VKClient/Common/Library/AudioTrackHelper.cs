...
namespace VKClient.Common.Library
{
    public static class AudioTrackHelper
    {
        ...
        public static AudioTrack CreateTrack(AudioObj audio)
        {
            ...
            //
            string temp = audio.UniqueId + "|" + audio.duration;
            //
            return new AudioTrack(new Uri(uriString, UriKind.RelativeOrAbsolute), audio.title ?? "NOTITLE", audio.artist ?? "NOARTIST", "", null, temp, (EnabledPlayerControls)31L);
        }
