...
namespace VKClient.Common.Backend
{
    public class AccountService
    {
        ...
        public void GetCounters(Action<BackendResult<OwnCounters, ResultCode>> callback)
        {
            ...
            VKRequestsDispatcher.DispatchRequestToVK<OwnCounters>("getCounters", parameters, callback, (Func<string, OwnCounters>)(jsonStr => CountersDeserializerHelper.Deserialize(jsonStr)), false, true, cancellationToken, null);
        }
        ...
        public void GetBaseData(PhoneAppInfo phoneAppInfo, Action<BackendResult<AccountBaseData, ResultCode>> callback, bool loadStickersInfo = false)
        {
            ...
            string str1 = color.R == 0 ? "dark" : "light";
            string str2 = "";
            ...
            Dictionary<string, string> parameters = new Dictionary<string, string>()
      {
        ...
        },
        {
          ...
          "5"
            ...
            Dictionary<string, string> parameters = new Dictionary<string, string>();
            parameters["fields"] = "photo_100,photo_50,exports,country,sex,status,bdate,first_name_gen,last_name_gen,verified";
            parameters["info_fields"] = "audio_ads,audio_background_limit,country,debug_available,gif_autoplay,https_required,intro,lang,money_clubs_p2p,money_p2p,money_p2p_params,music_intro,audio_restrictions,profiler_settings,raise_to_record_enabled,stories,masks,subscriptions,support_url,video_autoplay,video_player,vklive_app,community_comments";
            parameters["androidVersion"] = "23";
            parameters["androidManufacturer"] = "Fly";
            parameters["androidModel"] = "FS407";
            parameters["func_v"] = "9";
            VKRequestsDispatcher.DispatchRequestToVK<AccountBaseData>("execute.getUserInfo", parameters, callback, (Func<string, AccountBaseData>)(jsonStr =>
            {
        ...
        {
            //Dictionary<string, string> dictionary = new Dictionary<string, string>() { { "func_v", "2" } };
            //CancellationToken? cancellationToken = new CancellationToken?();
            //VKRequestsDispatcher.DispatchRequestToVK<AccountIntermediateData>("execute.getIntermediateData", dictionary, callback, (Func<string, AccountIntermediateData>)(jsonStr => JsonConvert.DeserializeObject<GenericRoot<AccountIntermediateData>>(jsonStr).response), true, true, cancellationToken, null);
        }
