...
namespace VKClient.Common.Backend
{
    public static class VKRequestsDispatcher
    {
        ...
        {
            get { return !string.IsNullOrEmpty(VKRequestsDispatcher._autorizationData != null ? VKRequestsDispatcher._autorizationData.access_token : null); }
        }

        public static AutorizationData AuthData
        {
            get { return VKRequestsDispatcher._autorizationData; }
        }

        public static string Token
        {
            get { return VKRequestsDispatcher._autorizationData == null ? "" : VKRequestsDispatcher._autorizationData.access_token; }
        }
            ...
            try
            {
                ...
                if (jtoken1 != null)
                {
                    ...
                    if (jtoken1.HasValues)
                    {
                        ...
                        if (jtoken2 != null)
                        {
                            resultData.ResultCode = (ResultCode)(int)jtoken2;
                        }
                ...
                if (jtoken3 != null)
                {
                    ...
                    if (errorList != null)
                    {
                        if (errorList.Count > 0)
                        {
                            ...
                            {
                                case ResultCode.TokenConfirmationRequired://///
