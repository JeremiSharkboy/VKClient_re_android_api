...
namespace VKClient.Common.Backend.DataObjects
{
    ...
    {
        public string src { get; set; }//src=https://sun9-15.userapi.com/c840222/v840222241/2e6af/OUz_ZSnHBtY.jpg
    ...
    {
        private string GetSrcBySize(string size)
        {
            if (sizes == null)
            {
                return null;
            }
            ImgSize iss = sizes.Find((i) => i.type == size);
            if (iss == null)
            {
                return sizes[0].src;
            }
        ...
        //todo:optimize?
        private void SetSrcBySize(string size, string src)
        {

            if (sizes == null)
            {
                sizes = new List<ImgSize>();
                ImgSize i = new ImgSize();
                i.src = src;
                i.type = size;
                sizes.Add(i);
                return;
        ...
        public List<ImgSize> sizes { get; set; }
        ...
        public string photo_75
        {
            ...
            get
            {
                return this.GetSrcBySize("s");
            }
            set
            {
                this.SetSrcBySize("s", value);
            }
        }
        ...
        public string photo_130
        {
            ...
            get
            {
                return this.GetSrcBySize("m");
            }
            set
            {
                this.SetSrcBySize("m", value);
            }
        }
        ...
        public string photo_604
        {
            ...
            get
            {
                return this.GetSrcBySize("x");
            }
            set
            {
                this.SetSrcBySize("x", value);
            }
        }
        ...
        public string photo_807
        {
            ...
            get
            {
                return this.GetSrcBySize("y");
            }
            set
            {
                this.SetSrcBySize("y", value);
            }
        }
        ...
        public string photo_1280
        {
            ...
            get
            {
                return this.GetSrcBySize("z");
            }
            set
            {
                this.SetSrcBySize("z", value);
            }
        }
        ...
        public string photo_2560
        {
            ...
            get
            {
                return this.GetSrcBySize("w");
            }
            set
            {
                this.SetSrcBySize("w", value);
            }
        }
        ...
        public void Read(BinaryReader reader)
        {
            ...
            this.SetSrcBySize("m", reader.ReadString());//this.src = reader.ReadString();
            this.SetSrcBySize("x", reader.ReadString());//this.src_big = reader.ReadString();
            this.SetSrcBySize("s", reader.ReadString());//this.src_small = reader.ReadString();
