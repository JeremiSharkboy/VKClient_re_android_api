...
namespace VKClient.Common.Emoji
{
    public class SpriteListControl : UserControl, ISupportDataContext, ISupportState, IHandle<StickersSettings.StickerRecentItemInsertedEvent>, IHandle, IHandle<PanelControlFocusedChangedEvent>, IHandle<PanelControlOpenedChangedEvent>, IHandle<DownloadSucceededEvent>, IHandle<DownloadFailedEvent>
    {
        ...
        private void CreateAndAddStickersItems()
        {
            ...
            {
                //
                if (this.CurrentDataContext.StickerProduct.stickers == null)
                    return;
                //
                ...
                List<IEnumerable<int>> list1 = Enumerable.ToList<IEnumerable<int>>(this.CurrentDataContext.StickerProduct.stickers.sticker_ids.Partition<int>(StickersConstants.ColumnsCountVerticalOrientation));
                List<IEnumerable<int>> list2 = Enumerable.ToList<IEnumerable<int>>(this.CurrentDataContext.StickerProduct.stickers.sticker_ids.Partition<int>(StickersConstants.ColumnsCountHorizontalOrientation));
