...
namespace VKClient.Common.Profiles.Shared.ViewModels
{
    public class ProfileViewModel : ViewModelBase, ICollectionDataProvider<WallData, IVirtualizable>, IHandle<WallPostDeleted>, IHandle, IHandle<WallPostAddedOrEdited>, IHandle<WallPostPinnedUnpinned>, IHandle<GroupMembershipStatusUpdated>, IHandle<FriendRequestAcceptedDeclined>, IHandle<FriendRemoved>, IHandle<FriendRequestSent>, IHandle<SubscriptionCancelled>, IHandle<BaseDataChangedEvent>, IHandle<CommunityLinkAddedOrEdited>, IHandle<CommunityLinkDeleted>, IHandle<CommunityManagerChanged>, IHandle<CommunityInformationChanged>, IHandle<CommunityServicesChanged>
    {
        ...
        private Group _groupData;//private GroupData _groupData;
        ...
        private bool HasCover
        {
            get
            {
                Group group = this._groupData;
                CoverImage coverImage = group.cover.CurrentImage;
                    string str = coverImage != null ? coverImage.url : null;
        ...
        public bool CanFaveUnfave
        {
            get
            {
                return this._profileData != null && this.Id != AppGlobalStateManager.Current.LoggedInUserId && !this.IsServiceProfile && (this.Id >= 0L || this._groupData == null || this._groupData.Privacy != GroupPrivacy.Private) && (!this._profileData.IsDeactivated || this._profileData.IsFavorite);
            }
        }
        ...
        public bool CanSubscribeUnsubscribe
        {
            get
            {
                ...
                if (this.Id < 0L)
                {
                    if (this._groupData == null || !this._groupData.IsMember && this._groupData.Privacy != GroupPrivacy.Public)
                        return false;
                    BanInfo banInfo = this._groupData.ban_info;
        ...
        public bool CanManageCommunity
        {
            get
            {
                ...
                int num1;
                    int? nullable = group != null ? new int?(group.admin_level) : new int?();
                    num1 = nullable.GetValueOrDefault() > 0 ? (nullable.HasValue ? 1 : 0) : 0;
        ...
        public void LoadInfo(bool preloaded = false)
        {
            ...
            if (this.Id > 0L)
                ...
                GroupsService.Current.GetGroupInfo(-this.Id, (Action<BackendResult<Group, ResultCode>>)(res => this.HandleProfileDataLoaded(res.ResultCode, (IProfileData)res.ResultData)));
        }
        ...
        private void HandleProfileDataLoaded(ResultCode resultCode, IProfileData profileData)
        {
            Execute.ExecuteOnUIThread((Action)(() =>
            {
                if (resultCode == ResultCode.Succeeded)
                {
                    ...
                    this._groupData = this._profileData as Group;
                    this.ProcessData();
        ...
        public void NavigateToNewWallPost()
        {
            if (this._profileData == null)
                return;
            Navigator.Current.NavigateToNewWallPost(Math.Abs(this.Id), this.Id < 0, this._profileData.AdminLevel, this._groupData != null && this._groupData.GroupType == GroupType.PublicPage, false, false);
        }
        ...
        private void FaveUnfaveGroup()
        {
            ...
            FavoritesService.Instance.FaveAddRemoveGroup(-this.Id, !isFavorite, (Action<BackendResult<VKClient.Common.Backend.DataObjects.ResponseWithId, ResultCode>>)(res => Execute.ExecuteOnUIThread((Action)(() =>
            {
                ...
                favedUnfavedEvent.group = this._groupData;
                int num = this.IsFavorite ? 1 : 0;
        ...
        public void Handle(CommunityLinkAddedOrEdited message)
        {
            ...
            {
                if (this._groupData.links == null)
                    this._groupData.links = new List<GroupLink>();
                this._groupData.links.Insert(0, message.Link);
            }
            else
            {
                if (this._groupData.links == null)
                    return;
                GroupLink groupLink = (GroupLink)Enumerable.FirstOrDefault<GroupLink>(this._groupData.links, (Func<GroupLink, bool>)(l => l.id == message.Link.id));
                if (groupLink == null)
                    return;
        ...
        {
            if (this._groupData == null || message.CommunityId != this._groupData.Id || this._groupData.links == null)
                return;
            GroupLink groupLink = (GroupLink)Enumerable.FirstOrDefault<GroupLink>(this._groupData.links, (Func<GroupLink, bool>)(l => l.id == message.LinkId));
            if (groupLink == null)
                return;
            this._groupData.links.Remove(groupLink);
        }
            ...
            switch (message.EditingMode)
            {
                case EditingMode.Adding:
                    if (!message.IsContact)
                        break;
                    if (this._groupData.contacts == null)
                        this._groupData.contacts = new List<GroupContact>();
                    //if (this._groupData.contactsUsers == null)
                    //    this._groupData.contactsUsers = new List<User>();
                    this._groupData.contacts.Add(new GroupContact()
                    {
                ...
                case EditingMode.Editing:
                    ...
                    //if (this._groupData.contactsUsers == null)
                    //    this._groupData.contactsUsers = new List<User>();
                    GroupContact groupContact1 = (GroupContact)Enumerable.FirstOrDefault<GroupContact>(this._groupData.contacts, (Func<GroupContact, bool>)(c => c.user_id == message.ManagerId));
                ...
                case EditingMode.Removing:
                    ...
                    {
                        Group group = this._groupData;
                        if ((group != null ? group : null) != null)
                        {
                            this._groupData.admin_level = (int)message.Role;
                            // ISSUE: method reference
                    ...
                    if (/*this._groupData.contactsUsers == null ||*/ this._groupData.contacts == null)
                        break;
                    GroupContact groupContact2 = (GroupContact)Enumerable.FirstOrDefault<GroupContact>(this._groupData.contacts, (Func<GroupContact, bool>)(c => c.user_id == message.ManagerId));
                    if (groupContact2 != null)
                        this._groupData.contacts.Remove(groupContact2);
