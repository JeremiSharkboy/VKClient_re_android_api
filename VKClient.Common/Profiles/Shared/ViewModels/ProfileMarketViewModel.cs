    ...
    public class ProfileMarketViewModel : ViewModelBase, IMediaHorizontalItemsViewModel, ICollectionDataProvider2<VKList<Product>, MediaListItemViewModelBase>
    {
        ...
        public Func<VKList<Product>, ListWithCount<MediaListItemViewModelBase>> ConverterFunc
        {
            get
            {
                ...
                {
                    ListWithCount<MediaListItemViewModelBase> listWithCount = new ListWithCount<MediaListItemViewModelBase>() { TotalCount = products.count };
        ...
        public void Unload()
        {
            using (IEnumerator<MediaListItemViewModelBase> enumerator = this._items.GetEnumerator())
            {
                while (enumerator.MoveNext())
                    ((ProductMediaListItemViewModel)enumerator.Current).ImageUri = null;
            }
        }
