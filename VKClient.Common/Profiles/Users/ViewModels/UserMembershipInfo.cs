    ...
    public class UserMembershipInfo : MembershipInfoBase
    {
        ...
        public override Visibility VisibilityButtonSecondaryAction
        {
            get
            {
                if (this._userData == null || this._userData.Id == AppGlobalStateManager.Current.LoggedInUserId)
                    return Visibility.Collapsed;
                switch ((FriendshipStatus)this._userData./*friend.*/friend_status)
                {
        ...
        public override bool SupportMultipleAddActions
        {
            ...
            {
                if (this._userData != null)
                    return (FriendshipStatus)this._userData./*friend.*/friend_status == FriendshipStatus.RequestReceived;
                return false;
            }
        }
        ...
        private void AddDeleteFriend(bool delete = false)
        {
            ...
            else
            {
                ...
                bool add = (FriendshipStatus)this._userData./*friend.*/friend_status == FriendshipStatus.No || (FriendshipStatus)this._userData./*friend.*/friend_status == FriendshipStatus.RequestReceived && !delete;
                ...
                UsersService.Instance.FriendAddDelete(userId, add, (Action<BackendResult<OwnCounters, ResultCode>>)(res =>
                {
                    ...
                    {
                        case FriendshipStatus.No:
                            EventAggregator.Current.Publish(new FriendRequestSent() { UserId = userId });
                            break;
                        case FriendshipStatus.RequestSent:
